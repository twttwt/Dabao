package com.twt.router_runtime
...
object Router {
    ...
    //编译期间生产的总映射表
    private const val GENERATED_MAPPING = "com.twt.dabao.mapping.generated.RouterMapping"
    ...
    fun go(context: Context, url: String) {
        ...
        //匹配URL,找到目标页面
        //router://imooc/profile?name=imooc&maeeage=hello
        ...
        if (targetActivityClass==""){
            Log.i(TAG,"go : no destination found")
            return
        }
